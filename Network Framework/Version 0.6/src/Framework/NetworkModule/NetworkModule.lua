...
function NetworkPrototype:__RegisterSignal(eventName: string, property: signalProperty, eventID: number)
...
function NetworkPrototype:__ReplicateStorage(key: string, value: any)
...
function NetworkPrototype:CreateSignal(eventName: string, property: signalProperty?, eventID: number?)
...
function NetworkPrototype:CreateLocalSignal(eventName: string, property: signalProperty?)
