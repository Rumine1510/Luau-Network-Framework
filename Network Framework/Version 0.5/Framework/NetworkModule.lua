...
function NetworkPrototype:__AddQueue(key: string, params: signalParams, args: {any})
...
function NetworkPrototype:ConnectLocalSignal(eventName: string, func: func)
...
function NetworkPrototype:InvokeLocalSignal(eventName: string, params: signalParams?, ...: any)
