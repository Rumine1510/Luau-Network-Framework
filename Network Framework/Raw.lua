...
function NetworkPrototype.__AddQueue(self: network, Key: string, properties: signalProperty, args: {any})
...
function SignalMethods.Connect(self: customSignal, func: (...unknown) -> (...unknown)): customConnection
...
function SignalMethods.Fire(self: customSignal, property: signalProperty, ...: unknown)
...
function SignalMethods.Invoke(self: customSignal, property: signalProperty, ...: unknown): unknown
...
function NetworkPrototype.FireSignal(self: network, eventName: string, property: signalProperty, ...: unknown)
...
function NetworkPrototype.InvokeSignal(self: network, eventName: string, property: signalProperty, ...: unknown)
...
function TroveMethods.Set(self: trove, tbl: {[unknown]: unknown}, key: unknown, value: unknown)
...
function TroveMethods.Insert(self: trove, tbl: {unknown}, value: unknown)
