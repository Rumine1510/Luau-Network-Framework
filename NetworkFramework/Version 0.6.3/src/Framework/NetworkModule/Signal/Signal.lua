...
export type customConnection = Connection.customConnection
type func = (...any) -> (...any)
...
function Signal.new(signalID: number, signalName: string?, signalProperty: signalProperty?): customSignal
	...
	newSignal.Key = encodeKey(signalID) :: string
...
export type customSignal = typeof(Signal.new(0, "test", Signal.newProperty()))
